...
" Vim UI {
    ...
    set cursorcolumn " show vertical position of cursor
    ...
    if has('statusline')
        ...
        set statusline+=%{HGRev_statusline()}
...
" Key (re)Mappings {
    ...
    nmap cm :w<CR>:silent CoffeeMake!<CR>
    imap cm <ESC>:w<CR>:silent CoffeeMake!<CR>i
...
" GUI Settings {
    ...
    if has('gui_running')
        ...
        set guioptions-=l " remove left-handed scrollbar
        set lines=40                " 40 lines of text instead of 24,
        if has("gui_gtk2")
            set guifont=Consolas\ Regular\ 14,Andale\ Mono\ Regular\ 14,Menlo\ Regular\ 13,Courier\ New\ Regular\ 16
        else
            set guifont=Consolas\ Regular:h14:cRUSSIAN,Andale\ Mono\ Regular:h14,Menlo\ Regular:h13,Consolas\ Regular:h14,Courier\ New\ Regular:h16
        endif
    else
